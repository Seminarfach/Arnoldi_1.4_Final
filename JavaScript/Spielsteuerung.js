...
class GameController {
    ...
    setupStartScreenButtons() {
        ...
        guide.innerHTML = '';
                    ...
                    imgPC.src = './img/Anleitung/SteuerungPC.png'
                   
                    imgPC.style.maxWidth = '100%';
                    ...
                    const imgEinleitungUrkunde = document.createElement('img')
                    imgEinleitungUrkunde.src = './img/Anleitung/Einleitung Urkunde.png'

                    imgEinleitungUrkunde.style.maxWidth = '100%'
                    ...
                    schließenButton.textContent = 'Weiter'
                    ...
                    endButton.textContent = 'Schließen'
                    
                    endButton.style.textAlign = "1vw"
                    endButton.style.cursor = "pointer"
                    endButton.style.width = "100%"
                    endButton.style.height = "200%"
                    endButton.style.border =  "black, solid 0.3vw";
                        ...
                        if(!isClicked) {
                            ...
                            gsap.to('#overlappingDiv', {
                                ...
                                onComplete: () => {
                                    ...
                                    guide.innerHTML = ''
                                    guide.scrollTop = 0
                                    guide.appendChild(imgEinleitungUrkunde)
                                    guide.appendChild(scrollHint)
                                    guide.appendChild(endButton)
